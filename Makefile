...
LIBSRC := src/strfuncs.cpp src/strsplit.cpp src/strstr.cpp src/sort.cpp src/pvector.cpp src/hash.cpp src/gdb_assertions.cpp src/data_structure.cpp src/argparse.cpp 
...
TESTSRC := test/strstr.cpp test/strfuncs.cpp test/test_cppvector.cpp test/test_crc32.cpp test/test_pvector.cpp
